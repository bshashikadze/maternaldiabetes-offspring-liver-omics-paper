...
The proteomics dataset has been submitted to the [ProteomeXchange](http://www.proteomexchange.org/) Consortium via the PRIDE [1] partner repository (). Metabolomics and clinical-parameters data can be found in supplementary tables associated to the manuscript.
