...
![](multi-omics_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
```
    ...
    ## The RV coefficient of this coinertia analysis is: 0.7920345
...
```
    ...
    ## Permutation based p-value is 0.004975124
...
scale_shape_manual(values = c('Proteomics' = 16, 'Metabolomics' = 15))+
scale_color_manual(values = c('PHG' = "#e95559ff", 'PNG' = "#0088AA"))+
...
geom_hline(yintercept = 0, linetype = "dashed")+
geom_vline(xintercept = 0, linetype = "dashed")+
theme_bw() + theme(panel.border = element_rect(linewidth =  1),
                   axis.title = element_text(size  = 9, colour="black"), 
                   axis.text.x = element_text(size = 9, colour="black"), 
                   axis.text.y = element_text(size = 9, colour="black"),
panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
...
![](multi-omics_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
