...
script of co-inertia analysis  and visualization was adapted from https://github.com/bshashikadze/diabetes-lung-omics-paper/tree/main/multiomics%20coinertia


CIA is based on:
Meng, C., B. Kuster, A.C. Culhane, and A.M. Gholami, A multivariate approach to the integration of multi-omics datasets. BMC Bioinformatics, 2014. 15(1): p. 162.
